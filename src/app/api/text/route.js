...
const genAI = new GoogleGenerativeAI('AIzaSyD5B6eOHh4diQffM0FWWL6aNHZqzsUfKTI');
...
4. Do not include any additional commentary`;
    ...
    throw new Error('Failed to generate abstractive summary');
  }
};
...
- Summary: ${analysis.summaryReadingTime} minute${analysis.summaryReadingTime > 1 ? 's' : ''}`;
      ...
      return NextResponse.json(
        { error: 'Failed to generate summary. Please try with different text.' },
        { status: 500 }
      );
    }
